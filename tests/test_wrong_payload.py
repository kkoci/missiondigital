...
class TestParse(unittest.TestCase):
    ...
    def test_parse_invalid_data(self):
        ...
        input_json = {
            ...
            "FirstFrameNumber": 0000000,
            "LastFrameNumber": 1240067
        }

        # Send a POST request to the "/parse" route with the invalid data.
        ...
        # Assert that the response data is not as expected.
        self.assertNotEqual(parsed_json, {
